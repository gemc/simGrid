...
def create_merge_background(sconfiguration):
    ...
    return (
        ...
        'run_timed require_executable "bg-merger"\n'
        'cmd=(bg-merger\n'
        '    -b "$BG_FILE"\n'
        '    -i gemc.hipo\n'
        '    -o gemc.merged.hipo\n'
...
def create_denoiser(sconfiguration, denoise_version):
    ...
    return (
        ...
        'run_timed require_executable "denoise2.exe"\n'
...
def create_reconstruction(sconfiguration):
    ...
    the direct GEMC output, after optional background merging.  workflow_run:
    workflows: [ "Test" ]
    types: [ completed ]
    branches: [ main ]
...
def create_test_hipo(sconfiguration):
    ...
    return (
        ...
        'run_timed require_executable "hipo-utils"\n'
